...
import { getAllProducts } from './apis/product.js';
import { useDispatch, useSelector } from 'react-redux';
import { populateCategory, populateProducts } from './store/slice/contentSice.js';

function App() {
  const { products, categories } = useSelector(state => state.contentStore)
  ...
  const handleGetAllCategories = async () => {
    ...
    dispatch(populateCategory(result.data))
  };
