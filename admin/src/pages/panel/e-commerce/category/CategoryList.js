...
import { createCategory, handleDeleteCategory, updateCategory } from "../../../../apis/category";
import { toast } from "react-toastify"; 
import { toastStyle } from "../../../../utils/Constants";
import { useSelector } from "react-redux";
import { addCategories } from "../../../../store/slice/contents";
...
const CategoryList = () => {
  ...
  const onEditSubmit = async () => {
    ...
    // UPDATE REDUX STATE
    dispatch(addCategories(newItems))
  ...
  const deleteCategory = async (id) => {
    ...
    // UPDATE REDUX STATE
    dispatch(addCategories(defaultData))
    setIsLoading(false)
    setData([...defaultData]);
  };
